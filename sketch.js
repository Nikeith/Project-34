...
function setup() {
  ...
  box11 = new Box(900, 170, 70, 70);
  box12 = new Box(900, 240, 70, 70);
  ...
  box20 = new Box(800, 170, 70, 70);
  box21 = new Box(800, 240, 70, 70);
  box22 = new Box(800, 310, 70, 70);
  box23 = new Box(800, 380, 70, 70);
  box24 = new Box(800, 450, 70, 70);
  box25 = new Box(800, 520, 70, 70);
  box26 = new Box(800, 590, 70, 70);
